...
Versions are dated (`YYYY-MM-DD`). Entries below are reverse-chronological. Entries that change the wire format or observable behavior are tagged **Breaking change** in the right-side filter panel — read those carefully before rolling forward. For the recommended upgrade workflow, see [Versioning strategy](/core-api/api-versioning/strategy).

<Update label="2026-04-24" description="Optional provider specialty and encounter date for note generation." tags={["New Release"]}>
  - Introduce an optional provider `specialty` field. This field lets you set a user's medical specialty. If set, it will for now have no impact, but in the near future, this piece of information will be leveraged to improve the dictation, transcription, and note generation.
...
<Update label="2026-03-16" description="Bulk Dot Phrase management and stricter patient instructions error handling." tags={["New Release", "Breaking change"]}>
...
<Update label="2026-02-20" description="Diarization support, required locale/template, and JWT audience deprecations." tags={["Breaking change", "New Release"]}>
  ...
  - **Diarization support.**
    ...
    - Diarization support for transcription HTTP endpoints (`/transcribe` and `transcribe-async`).
      Starting with this API version, the returned transcript items include an inferred `speaker_type` for each item.
...
<Update label="2025-11-14" description="Structured context for note generation and field renames." tags={["New Release", "Breaking change", "Improvements"]}>
...
<Update label="2025-08-05" description="Structured context for note generation, including active diagnoses coding." tags={["New Release"]}>
...
<Update label="2025-07-24" description="Dictation text replacements, French per-section customization, and dictation context." tags={["New Release", "Improvements"]}>
...
<Update label="2025-05-21" description="HCC and MCC indicators on normalized FHIR conditions." tags={["New Release"]}>
  - Add new boolean fields `is_hcc` and `is_mcc` to the FHIR condition objects returned by the `/generate-normalized-data` endpoint.
</Update>

<Update label="2025-05-07" description="New simpler and faster dictation WebSocket protocol." tags={["Breaking change"]}>
...
<Update label="2025-05-05" description="Corresponding note problem in normalized conditions." tags={["New Release"]}>
...
<Update label="2025-04-03" description="Persistent user note settings and per-section customization." tags={["New Release", "Breaking change"]}>
...
<Update label="2025-02-25" description="Bilingual transcription support (speech_locale → speech_locales)." tags={["New Release", "Breaking change"]}>
...
<Update label="2025-01-07" description="New dictation endpoints and required regional hosts." tags={["New Release", "Breaking change"]}>
...
<Update label="2024-12-23" description="Audio chunk acknowledgement protocol and required base paths." tags={["New Release", "Breaking change"]}>
...
<Update label="2024-11-08" description="Consistent SCREAMING_SNAKE_CASE for Transcribe WebSocket frames." tags={["Breaking change"]}>
...
<Update label="2024-10-01" description="New major API version with OAuth, webhooks, simpler transcription and note generation." tags={["New Release", "Breaking change"]}>
...
<Update label="2024-04-22" description="Patient instructions, normalized data, dictation WebSocket, and Dot Phrases." tags={["New Release", "Breaking change"]}>
...
<Update label="2024-02-27" description="User activation endpoints, problem-based splitting, and deprecated Spanish note generation." tags={["New Release", "Breaking change"]}>
...
<Update label="2023-06-26" description="First public release of the Nabla Core API." tags={["New Release"]}>
