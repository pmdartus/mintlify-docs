...
Create a new webhook in [Webhooks](https://pro.nabla.com/developers/webhooks) from the API Admin Console. Pick the event types you want delivered, then copy the **signature secret key** Nabla generates — you'll need it for verification.
